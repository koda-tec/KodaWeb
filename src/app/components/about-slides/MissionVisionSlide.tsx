...
const ValueItem = ({ icon, text }: { icon: React.ReactNode, text: string }) => (
  <div className="flex flex-col items-center text-center">
    <div className="text-3xl md:text-4xl text-koda-blue-deep mb-2">{icon}</div>
    <span className="text-sm md:text-base text-koda-dark">{text}</span>
  </div>
);
...
export const MissionVisionSlide = () => (
  <div className="p-6 md:p-10 text-center min-h-[70vh] flex flex-col justify-center">
    <div className="grid md:grid-cols-2 gap-8 mb-8">
      <div>
        <h3 className="text-xl md:text-2xl font-bold text-koda-dark flex items-center justify-center gap-2"><FaBullseye /> Misión</h3>
